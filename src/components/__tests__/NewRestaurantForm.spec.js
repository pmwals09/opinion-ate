...
describe('NewRestaurantForm', () => {
  ...
  describe('when empty', () => {
    beforeEach(async () => {
      ...
      const {getByPlaceholderText, getByTestId} = context;
      // there is an issue using userEvent.type or userEvent.keyboard with an empty input, cf: https://github.com/testing-library/user-event/issues/633
      await userEvent.click(getByPlaceholderText('Add Restaurant'));
      userEvent.click(getByTestId('new-restaurant-submit-button'));
